...
export default function Analyze() {
    ...
    return (
      <>
        <Typeahead
          ...
          options={getData().then(data=>data.map(option=>option.name))}
  ...
  const getData = async ()=>{
    await fetch('http://localhost:3000/getdrugs').then(
    ...
    <>
      <Container className="ana-container">
        <Row className="ana-container">
          <Col className="c-1 ana-col">{drugTypeAhead()}</Col>
          <Col className="c-2 ana-col">2 of 3</Col>
          <Col className="c-3 ana-col">3 of 3</Col>
